...
import { ArrowLeft, CalendarDays, ClipboardCheck, FileText, MapPin, Pencil, Plus, Users } from "lucide-react";
...
export default async function JobPage({ params, searchParams }: JobPageProps) {
  ...
  const { data: job, error } = await supabase.from("inspection_jobs").select(`
    id, job_number, status, report_type, inspection_at, prior_job_id, summary, escrow_number, internal_notes, created_at,
